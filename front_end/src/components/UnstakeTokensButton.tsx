...
export interface UnstakeTokensButtonProps {
    tokenAddress: string,
    amount: number,
    functionality: Functionality.Loan | Functionality.Withdraw
}

export const UnstakeTokensButton = ({ tokenAddress, amount, functionality }: UnstakeTokensButtonProps) => {
    ...
    const handleUnstakeSubmit = () => {
        return unstakeTokensSend(tokenAddress, utils.parseUnits(amount.toString(), decimals))
    }
