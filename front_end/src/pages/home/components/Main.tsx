...
export const Main = () => {
  ...
  const potamusLoanAddress = chainId
    ? networkMapping[String(chainId)]["PotamusLoan"][0]
  ...
  const tokenBalanceArray = useAccountBalance(
  ...
  return (
    <div>
      ...
      <Box>
        ...
        <AddressAmountButton
          functionality={Functionality.Deposit}
        ></AddressAmountButton>
      </Box>
      <Box>
        <h1> Potamus Pools </h1>
